                ...
                <div className="row">
                    <div className="col" style = {{textAlign: 'left',fontSize:'21px'}}onChange={this.handleChange}>
                            ...
                            {this.state.showInputForm && 
                                <div>
                                    <h4>Number of points(n)  : &nbsp;&nbsp;<Input size="large" name="numberpoint" value={this.state.numberpoint}style={{ width: 150 }}></Input></h4><br />
                                    <h4>X  : &nbsp;&nbsp;<Input size="large" name="xfind" value={this.state.xfind}style={{ width: 150 }}></Input></h4><br />
                                    ...
                                    <Button id="dimention_button"size="large" onClick= {
                                        ()=>{this.createTableInput(parseInt(this.state.numerpoint));
